...
public class OnlineNewsPopularityGA extends OnlineNewsPopularityBase {
	...
	public static void main(String[] args) throws IOException {
		...
		// value of runsf rom command line
		if (args.length != 0) {
			population = Integer.valueOf(args[0]);
			toMate = Integer.valueOf(args[1]);
			toMutate = Integer.valueOf(args[2]);
		}
		...
		writeFields("Error_" + population + "_" + toMate + "_" + toMutate + "_" + oaNames + ".csv", fields);
		...
		write(oaNames + population + "_" + toMate + "_" + toMutate + "_weights.txt", network.getWeights());
	...
	private static void initializeOptimizers() {
		...
		oa = new StandardGeneticAlgorithm(population, toMate, toMutate, nnop);
	}
